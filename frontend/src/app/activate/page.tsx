...
export default function ActivatePage() {
  ...
  if (step === 'success' && activationResult) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <CheckCircle className="h-12 w-12 text-green-500 mx-auto mb-4" />
            <CardTitle className="text-2xl">SchemeKnit Activated</CardTitle>
          </CardHeader>
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>Set up the administrator for {activationResult?.school?.name || 'your school'}</CardDescription>
          </CardHeader>
          <CardContent>
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Welcome to SchemeKnit</CardTitle>
          <CardDescription>
            This installation requires a school license to unlock licensed features.
          </CardDescription>
        </CardHeader>
        <CardContent>
