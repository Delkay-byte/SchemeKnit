  ...
  return (
    <div className="max-w-2xl space-y-4">
      <h1 className="text-2xl font-bold flex items-center gap-2">
        <Key className="h-6 w-6" /> License &amp; Entitlement
      </h1>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            <div className="flex justify-between border-b py-2">
              ...
              <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${active ? 'bg-green-100 text-green-700' : 'bg-orange-100 text-orange-700'}`}>
                {lic.status}
              </span>
            </div>
            <div className="flex justify-between border-b py-2">
