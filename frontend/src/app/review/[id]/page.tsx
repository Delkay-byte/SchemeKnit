...
export default function ReviewPage() {
  ...
  const weekTypeBadge = (type: string) => {
    const colors: Record<string, string> = {
      instruction: 'bg-blue-100 text-blue-800',
      revision: 'bg-yellow-100 text-yellow-800',
      assessment: 'bg-red-100 text-red-800',
      sba: 'bg-purple-100 text-purple-800',
                  ...
                  {weeks.map((week) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <span className={`text-xs px-2 py-0.5 rounded-full ${weekTypeBadge(week.week_type)}`}>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <CardTitle className="flex items-center gap-2">
                          ...
                          <span className={`text-sm px-2 py-0.5 rounded-full ${weekTypeBadge(currentWeek.week_type)}`}>
